    ...
    <div class="container-fixed flex items-center justify-between flex-wrap gap-3">
        <div class="flex items-center flex-wrap gap-1 lg:gap-5">
            <h1 class="font-medium text-base text-gray-900">
                Thêm thành viên vào {{$department->name}}
            </h1>
        </div>
...
@endsection
@push("actions")
<button class="btn btn-success" onclick="saveAddMemberTeam({{$department->id}})">
    Thêm thành viên
</button>
@endpush
@push("scripts")
...
<script type="text/javascript" src="{{ asset('assets\js\dashboard\account\employee\team\addmember.js')}}"></script>
@endpush