                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="w-full h-2.5 bg-gray-200 rounded-full">
                            <div class="h-2.5 bg-blue-800 rounded-full" style="width: {{ $overallProgress }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-header bg-white border-b border-gray-100">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('dashboard.account.task.task') }}?filter[contract_id]={{ $details['id'] }}" class="btn btn-light btn-xs">
                            <i class="ki-filled ki-fasten"></i>
                            Xem trong Task Manager
                        </a>
                        @if ($details['status'] == 1)
                        <button class="btn btn-light btn-xs" onclick="syncContractTasks({{$details['id']}})">
                    ...
                    <div class="task-tree">
                        ...
                        <div class="task-item main-task border-b border-gray-100 hover:bg-gray-50">
                            <div class="p-4 flex items-center justify-between cursor-pointer" onclick="toggleTaskChildren(this)">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="badge badge-sm badge-outline badge-{{ $mainTask['status']['color'] }}">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <div class="w-20 h-1.5 bg-gray-200 rounded-full">
                                            <div class="h-1.5 rounded-full !bg-blue-800" style="width: {{ $mainTask['progress'] }}%;"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="task-children pl-8 hidden">
                                ...
                                <div class="task-item child-task border-t border-gray-100 hover:bg-gray-50">
                                    <div class="p-3 flex items-center justify-between cursor-pointer" onclick="toggleTaskChildren(this)">
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div class="badge badge-sm badge-outline badge-{{ $childTask['status']['color'] }}">
                                        ...
                                        <div class="task-item sub-child-task border-t border-gray-100 hover:bg-gray-50">
                                            <div class="p-2 flex items-center justify-between">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <div class="badge badge-sm badge-outline badge-{{ $subChildTask['status']['color'] }}">
...
<script>
    ...
    async function syncContractTasks(contractId) {
        Notiflix.Confirm.show(
            'Đồng bộ công việc',
            'Bạn có chắc chắn muốn đồng bộ lại trạng thái và số lượng công việc của hợp đồng này?',
            'Đồng bộ',
            'Huỷ',
            async () => {
                    Notiflix.Loading.circle('Đang đồng bộ...');

                    let method = "post",
                        url = "/contract/sync-contract-tasks",
                        params = null,
                        data = {
                    ...
                    try {
                        ...
                        Notiflix.Loading.remove();
                        showAlert('error', 'Đã có lỗi xảy ra khi đồng bộ công việc');
                    }
                },
                () => {}, {},
        );
